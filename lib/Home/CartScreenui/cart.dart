          ...
          child: InkWell(
            onTap: () {
              for (int i = 0; i < add_to_cart.length; i++) {
                qty = (qty + add_to_cart[i]['price']).toInt();
                amount = amount + add_to_cart[i]['price'];
              }
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: Colors.white10, width: 0.2)),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: [
                              Container(
                              ...
                              Align(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        add_to_cart[index]['name'],
                                        overflow: TextOverflow.clip,
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 20),
                                      ),
                                      Text(
                                        add_to_cart[index]['categories'],
                                        style: TextStyle(
                                            color: Colors.pink, fontSize: 20),
                                      ),
                                      Text(
                                        '\$' +
                                            add_to_cart[index]['price']
                                                .toString(),
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 20),
                                      ),
